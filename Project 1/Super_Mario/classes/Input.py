...
class Input:
    ...
    def checkForKeyboardInput(self):
        ...
        # -------------------OPEN CV
        if codigo_opencv.isMovingLeft:
            self.entity.traits["goTrait"].direction = -1
        if codigo_opencv.isMovingRight:
            self.entity.traits["goTrait"].direction = 1
        # ---------------------------

        isJumping = pressedKeys[K_SPACE] or pressedKeys[K_UP] or pressedKeys[K_k] or codigo_opencv.isJumping  #-------- alterado OPENCV
